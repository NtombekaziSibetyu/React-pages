...
import "./../Styling/DoctorDetails.css";
  ...
  render() {
    return (
      <div>
        ...
        <div className="box">
          <p>Practise number : 0000889</p>
          <p>Email : user@email.com</p>
          <p>Contact : 011 7899 123</p>
          <p>Location : 1234 Quary Road Fog City</p>
        </div>
        <div>
